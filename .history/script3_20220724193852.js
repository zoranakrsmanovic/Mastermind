...
const solutionTester = {
  ...
  testWhite: function () {
    ...
    result.current_color_cell += result.white;
  },
};
...
const coloringCells = function(){
    ...
    colorCells[0].style.backgroundColor = "red";
    colorCells[1].style.backgroundColor = "green";
    colorCells[2].style.backgroundColor = "blue";
