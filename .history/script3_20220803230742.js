...
const displayWinOrGameOver = function (message) {
  ...
  let hsc = localStorage.getItem("highScore");
  if (hsc == null) {
    console.log("highscore nije postojao");
    localStorage.setItem("highscore", currentScore);
  } else if (hsc < currentScore) {
    console.log("highscore je manji od current score" + hsc);
    localStorage.setItem("highscore", currentScore);
  } else {
    console.log(`Curren score ${currentScore}, highScore ${hsc}`);
  }
