...
const deleteDispleyedCombination = function () {
  for (let i = 0; i < secretCombinationsEl.length; i++) {
    secretCombinationsEl[i].classList.remove(
      JAVA_SCRIPT,
      ANGULAR,
      C_S_S,
      REACT
    );
    combinationRowEl[i].classList.add("row-0");
  }
};
...
const reset = function () {
  ...
  console.log("Guess kombinacija" + guess);
};
